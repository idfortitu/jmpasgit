Partial Public Class Defunt
    ...
    Public ReadOnly Property EtatCivilComplet As String
        Get
            Return Uzineagaz.TEtatCivilToString(EtatCivil) & If(EtatCivilDe <> "", " de " & EtatCivilDe, "")
        End Get
    End Property

    Public ReadOnly Property RefEmpl As String
        Get
            If Emplacement IsNot Nothing Then
