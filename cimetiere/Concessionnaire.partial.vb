...
Partial Public Class Concessionnaire
    ...
    ' comme la fk est dans la concession, le data model veut que le rapport soit 1 concessionnaire - n concessions, mais il n'y en aura jamais qu'une seule
    ...
    ' Interface et raccourcis (pour ne pas devoir écrire machin.Habiter.LocPays.Loc.Ville, etc, et pour peut-être un jour utiliser des fonctions communes)
#Region "Interface IPersonne"
